# tushare-daily-quick-register-task Specification

## Purpose
Defines the quick-register extension for TuShare A-share daily bar data (open, high, low, close, vol, etc.) for a given symbol, enabling factor DB population via a single extension file drop.
